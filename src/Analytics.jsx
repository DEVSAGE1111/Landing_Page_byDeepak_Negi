...
function Analytics() {
  return (
    <div  className='flex justify-center p-32 gap-20 ml-12 font2'>
      <img className='mb-12' src="https://d9hhrg4mnvzow.cloudfront.net/templates.unbounce.com/o-saas/55cdb4b5-o-saas-product-shot.svg"/>
        <div className='flex flex-col gap-8  pr-24'>
            <h1 className='text-3xl  text-blue-800'>Product analytics answers your<br/> questions</h1>
     ...
     <div className='flex flex-col gap-16 mt-8 pr-16'>
